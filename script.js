...
while (restartGame) {
    ...
    // Verifies the user's entry for a range number is a number great than zero (NOTE: All numbers, positive or negative, have a default boolean value of true, except for zero which has a default boolean value of false. Also, NaN has a default boolean value of false.)
    ...
    while (true){
        ...
        // Checks is user guess correctly. If so, then the game ends
        if (guess === randomNum){
